                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> Pacientes <span class="caret"></span></a>
                     <ul class="dropdown-menu">
                      ...
                      <li class="letter-space"><a href="addPacient.php">Añadir Pacientes  <i class="fa fa-plus"></i> </a></li>
                    </ul>
                    </li>
                  <li><a href="profile.php?id=' .User::getLoggedUser()['DNI'].'"> Mi Perfil </a>
...
class DB
{
    ...
    public static function exists_id() {
    ...
    function  imprimeSearch($resultadoBusqueda, $rol){
        ...
        if($rol == 1){
            foreach($resultadoBusqueda as $regis){
                if ($control){
                    $control=false;
                    echo'<h2 id="searchResults" style="text-align: center; margin-left: -2%;">Resultados de la búsqueda de pacientes:</h2>';
                }
                ...
                echo "<a class='signup' href='pacientProfile.php?id=$DNI'> Ver Paciente </a>";

                echo "
                          <li>Tlfn: <b>{$regis['Telefono']}</b></li>
            ...
            echo ($control==true)? "<div><h3 style=\"text-align: center; display: inline-block; margin-left: 25%;\"> No se ha encontrado ningún resultado en la búsqueda de pacientes.</h3></div>":"";
            echo"<tr>";
            echo'</table></p>';
            ...
            foreach ($resultadoBusqueda as $regis) {
                if ($control) {
                    ...
                    echo '<h2 id="searchResults" style="display: inline-block; text-align: center; margin-left: 25%;">Resultados de la búsqueda de médicos:</h2>';
                    ...
                    echo "
                        <div id='pricing-table' style='  display: block; margin-left: 30%; float: bottom;'>
                            <div class='plan'>
                                ...
                                <h3>{$regis['Nombre']}<span><img src='$picture_src' style='height: 100px; width: 80px; border-radius: 50% ' ></span></h3>";

                    $Ncol = $regis['NColegiado'];
                    $id = $regis['DNI'];
                    echo "<a href='profile.php?id=".$id."' class='signup'> Ver perfil de médico </a>";
                   ...
                   ";
                    ...
                    echo ($control==true)? "<h3 style=\"text-align: center; display: inline-block; margin-left: 25%;\"> No se ha encontrado ningún resultado en la búsqueda de médicos.</h3>":"";
            ...
            foreach($resultadoBusqueda as $regis){
                if ($control){
                    $control=false;
                    echo'<h2 id="searchResults" style="text-align: center">Pacientes: </h2>';
                ...
                $DNI = $regis['DNI'];
                echo "<td><a class='enlace' href='pacientProfile.php?id=$DNI'> Ver Paciente </a></td>";
            }
            echo ($control==true)? "<h3 style=\"text-align: center; display: inline-block; margin-left: 40%;\"> No hay pacientes que mostrar.</h3>":"";
            echo"<tr>";
            echo'</table></p>';
