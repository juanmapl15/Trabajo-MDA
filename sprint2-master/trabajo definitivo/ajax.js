...
$(document).ready(function() {
    ...
    /* Edit Medico */
    $(document).on('submit', '#editMedForm', function() {
        event.preventDefault();
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if(data !== "") {
                                ...
                                swal({
                                    type: "error",
                                    title: "Error al actualizar la información del perfil",
                                    confirmButtonText: "Aceptar"
                                });
                            } else {
                                swal.close();
                                ...
                                swal({
                                    ...
                                    swal({
                                        title: 'Volviendo a su página de perfil...'
                                    });
                                    swal.showLoading();
                                });
                            }
                        ...
                        success: function(data) {
                            if(data !== "") {
                                ...
                                swal({
                                    ...
                                    window.location = 'pacientProfile.php?id=' + id;
